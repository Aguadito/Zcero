...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $finalidad = mysqli_real_escape_string($conex, $_POST['finalidad_credito']);
    $fecha_reg = date('Y-m-d H:i:s');

    $consulta = "INSERT INTO creditos_personal (
        nombre_completo, dni, correo, telefono,
        monto_solicitado, plazo, ingresos_mensuales,
        finalidad_credito, fecha_reg
    ) VALUES (
    ...
    if (mysqli_query($conex, $consulta)) {
        echo " Solicitud de crédito personal enviada correctamente.";
    } else {
